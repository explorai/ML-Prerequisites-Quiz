...
_Answers are available here:_  https://github.com/explorai/ML-Prerequisites-Quiz/blob/gh-pages/answerKeys.md _(Total of 30 questions).  You are responsible to assess your level (Recommended: 70% or better)_
...
A. Vectors are used only for numeric data, while list are useful for both numeric and string data.
